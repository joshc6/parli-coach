...
body{background:#0c0d0f;color:#f0f0ee;font-family:'DM Sans',sans-serif;-webkit-font-smoothing:antialiased}
::-webkit-scrollbar{width:4px}
::-webkit-scrollbar-track{background:transparent}
::-webkit-scrollbar-thumb{background:rgba(240,240,238,0.18);border-radius:2px}
textarea,input,select{font-family:'DM Sans',sans-serif;outline:none}
...
const s = {
  ...
  header: { background:RF.bg, borderBottom:"1px solid "+RF.hairline, padding:"0 28px", height:52, display:"flex", alignItems:"center", justifyContent:"space-between", flexShrink:0 },
  headerLeft: { display:"flex", alignItems:"center", gap:10 },
  logo: { width:28, height:28, borderRadius:6, border:"1px solid "+RF.hairlineHov, display:"flex", alignItems:"center", justifyContent:"center", color:RF.fg, fontSize:14 },
  ...
  sidebar: { width:224, background:RF.bg, borderRight:"1px solid "+RF.hairline, display:"flex", flexDirection:"column", gap:0, padding:0, overflowY:"auto", flexShrink:0 },
  sideSection: { padding:"16px", borderBottom:"1px solid "+RF.hairline },
  sideLabel: { margin:"0 0 10px 0", fontSize:9, fontWeight:500, color:RF.fgDim, textTransform:"uppercase", letterSpacing:"0.14em", fontFamily:RF.mono },
  textarea: { width:"100%", background:RF.bgInput, border:"1px solid "+RF.hairline, borderRadius:8, padding:"10px 12px", fontSize:12, color:RF.fg, resize:"none", fontFamily:RF.font, boxSizing:"border-box", lineHeight:1.6, transition:"border-color 0.15s" },
  select: { width:"100%", background:RF.bgInput, border:"1px solid "+RF.hairline, borderRadius:7, padding:"9px 10px", fontSize:12, color:RF.fg, fontFamily:RF.font, appearance:"none" },
  resInput: { width:"100%", background:RF.bgInput, border:"1px solid "+RF.hairline, borderRadius:8, padding:"10px 12px", fontSize:12, color:RF.fg, fontFamily:RF.font, boxSizing:"border-box", transition:"border-color 0.15s" },
  btnPrimary: { width:"100%", background:RF.fg, color:RF.bg, border:"none", borderRadius:7, padding:"9px 0", fontSize:12, fontWeight:600, cursor:"pointer", marginTop:10, transition:"opacity 0.15s" },
  btnSecondary: { width:"100%", background:"transparent", color:RF.fgMuted, border:"1px solid "+RF.hairlineHov, borderRadius:7, padding:"9px 0", fontSize:12, fontWeight:400, cursor:"pointer", marginTop:8 },
  ...
  actionBtn: { textAlign:"left", padding:"8px 10px", borderRadius:7, fontSize:12, fontWeight:400, border:"1px solid "+RF.hairline, background:"transparent", color:RF.fgMuted, cursor:"pointer", width:"100%", marginBottom:4 },
  exportBtn: { width:"100%", background:"transparent", border:"1px solid "+RF.hairline, borderRadius:7, padding:"8px 0", fontSize:12, fontWeight:400, color:RF.fgMuted, cursor:"pointer" },
  startBtn: { width:"100%", background:RF.fg, color:RF.bg, border:"none", borderRadius:8, padding:"13px 0", fontSize:13, fontWeight:600, cursor:"pointer", marginTop:6, letterSpacing:"-0.01em" },
  startBtnDisabled: { width:"100%", background:RF.hairline, color:RF.fgDim, border:"1px solid "+RF.hairline, borderRadius:8, padding:"13px 0", fontSize:13, fontWeight:600, cursor:"not-allowed", marginTop:6 },
  backBtn: { background:"none", border:"none", color:RF.fgDim, fontSize:11, cursor:"pointer", marginTop:16, fontFamily:RF.mono, display:"block", textAlign:"center", width:"100%", letterSpacing:"0.06em", textTransform:"uppercase" },
  sendBtn: { background:RF.fg, color:RF.bg, border:"none", borderRadius:8, padding:"10px 20px", fontSize:12, fontWeight:600, cursor:"pointer", flexShrink:0 },
  sendBtnRed: { background:"rgba(251,113,133,0.9)", color:"#fff", border:"none", borderRadius:8, padding:"10px 20px", fontSize:12, fontWeight:600, cursor:"pointer", flexShrink:0 },
  sendBtnDisabled: { background:RF.hairline, color:RF.fgDim, border:"1px solid "+RF.hairline, borderRadius:8, padding:"10px 20px", fontSize:12, fontWeight:600, cursor:"not-allowed", flexShrink:0 },
  smallBtn: { fontSize:10, fontWeight:500, padding:"4px 10px", borderRadius:5, border:"1px solid "+RF.hairlineHov, background:"transparent", color:RF.fgMuted, cursor:"pointer", fontFamily:RF.mono, letterSpacing:"0.06em", textTransform:"uppercase" },
  ...
  micBtn: function(rec) {
    return { width:40, height:40, borderRadius:8, border: rec ? "1px solid rgba(239,68,68,0.5)" : "1px solid "+RF.hairlineHov, cursor:"pointer", fontSize:16, flexShrink:0, color:RF.fg, background: rec ? "rgba(239,68,68,0.15)" : RF.bgSurf2, transition:"all 0.2s" };
  },
  ...
  msgUser: { maxWidth:560, background:RF.bgSurf2, border:"1px solid "+RF.hairlineHov, borderRadius:12, borderBottomRightRadius:3, padding:"12px 16px", fontSize:13, lineHeight:1.65, marginLeft:80, color:RF.fg },
  msgAsst: { maxWidth:660, background:RF.bgSurf, border:"1px solid "+RF.hairline, borderRadius:12, borderBottomLeftRadius:3, padding:"14px 18px", fontSize:13, lineHeight:1.65, marginRight:40, color:RF.fg },
  msgAsstOpponent: { maxWidth:660, background:RF.bgSurf, border:"1px solid rgba(251,113,133,0.2)", borderLeft:"2px solid rgba(251,113,133,0.6)", borderRadius:12, borderBottomLeftRadius:3, padding:"14px 18px", fontSize:13, lineHeight:1.65, marginRight:40, color:RF.fg },
  msgAsstJudge: { maxWidth:660, background:RF.bgSurf, border:"1px solid rgba(74,222,128,0.15)", borderLeft:"2px solid rgba(74,222,128,0.5)", borderRadius:12, borderBottomLeftRadius:3, padding:"14px 18px", fontSize:13, lineHeight:1.65, marginRight:40, color:RF.fg },
  ...
  inputTextarea: { flex:1, background:RF.bgInput, border:"1px solid "+RF.hairline, borderRadius:8, padding:"10px 14px", fontSize:12, color:RF.fg, resize:"none", fontFamily:RF.font, lineHeight:1.6 },
  transcriptBox: { flex:1, background:RF.bgInput, border:"1px solid "+RF.hairline, borderRadius:8, padding:"10px 14px", fontSize:12, color:RF.fg, minHeight:40, lineHeight:1.6 },
  ...
  landingCard: { background:"transparent", maxWidth:520, width:"100%", textAlign:"center", padding:"0 24px", animation:"fadeUp 0.5s ease both" },
  landingTitle: { fontSize:48, fontWeight:700, margin:"0 0 12px 0", letterSpacing:"-0.04em", color:RF.fg, lineHeight:1.05 },
  ...
  landingBtnCase: { background:RF.fg, color:RF.bg, border:"none", borderRadius:12, padding:"22px 16px", fontSize:13, fontWeight:600, cursor:"pointer", display:"flex", flexDirection:"column", alignItems:"center", gap:8 },
  landingBtnPractice: { background:"transparent", color:RF.fg, border:"1px solid "+RF.hairlineHov, borderRadius:12, padding:"22px 16px", fontSize:13, fontWeight:500, cursor:"pointer", display:"flex", flexDirection:"column", alignItems:"center", gap:8 },
  landingBtnSub: { fontSize:11, fontWeight:300, opacity:0.55, letterSpacing:"0.01em" },
  setupCard: { background:RF.bgSurf, border:"1px solid "+RF.hairline, borderRadius:16, padding:"40px 36px", maxWidth:460, width:"100%", animation:"fadeUp 0.4s ease both" },
  ...
  optionBtn: { padding:"12px 10px", borderRadius:8, fontSize:12, fontWeight:400, border:"1px solid "+RF.hairline, background:"transparent", color:RF.fgMuted, cursor:"pointer", textAlign:"center" },
  ...
  diffBtn: function(active, color, bg) {
    return { padding:"11px 8px", borderRadius:8, fontSize:11, textAlign:"center", cursor:"pointer", fontWeight: active ? 600 : 400, border: active ? "1px solid "+color : "1px solid "+RF.hairline, background: active ? "rgba(255,255,255,0.04)" : "transparent", color: active ? color : RF.fgMuted };
  },
};
...
function cleanForSpeech(text) {
  ...
  for (let k = 0; k < kills.length; k++) {
    const w = kills[k]; let idx = t.indexOf(w);
    while (idx !== -1) { t = t.slice(0,idx)+t.slice(idx+w.length); idx = t.indexOf(w); }
  }
  const out = [];
  for (let i = 0; i < t.length; i++) {
    const c = t[i]; const code = t.charCodeAt(i);
    if (c==="*"||c==="_"||c==="#"||c==="`"||c==="["||c==="]"||c==="~") out.push(" ");
    else if (code===8226||code===8212||code===8211) out.push(" ");
    else if (c==="-"&&i>0&&(t[i-1]==="\n"||t[i-1]===" "||t[i-1]==="\r")) out.push(" ");
    else if (c==="\n"||c==="\r") out.push(" ");
    else out.push(c);
  }
  let result = out.join("");
...
export default function App() {
  ...
  const startRecording = function() {
    ...
    doStopSpeaking(); setSpeaking(false);
    ...
    r.onresult = function(e) {
      ...
      setTranscript(finalText); setInterim(inter);
    };
  ...
  const stopRecording = function() { if (recognitionRef.current) recognitionRef.current.stop(); setRecording(false); setInterim(""); };

  const botSpeak = async function(prompt, msgType, isJudge) {
    const type = msgType||"opponent"; const judge = isJudge||false;
    setLoading(true);
    try {
      if (judge) {
    ...
    } catch(e) { setMessages(function(prev){return prev.concat([{role:"assistant",content:"Error: "+e.message,verbatim:"",type:type}]);}); }
    setLoading(false);
  };

  const generateResolution = async function() {
    setSetupLoading(true); setSetupResMode("generating");
    ...
    try {
      const text = await callAPI("Generate one unique specific high school parliamentary debate resolution about "+topic+". Seed: "+seed+". Return ONLY the resolution text starting with This house. No quotes no explanation.","You generate debate resolutions. Return only the resolution text, nothing else.");
      ...
      setSetupResText(fb[Math.floor(Math.random()*fb.length)]); setSetupResMode("done");
    }
  ...
  const startRound = async function() {
    ...
    setDifficulty(setupDifficulty); setResolution(res); setUserSide(uSide); setBotSide(bSide);
    setMessages([]); setRoundOver(false); setInput(""); setTranscript(""); setInterim("");
    if (setupSide==="opp") {
      setStage(1); setLoading(true); setAppMode("practice");
      try {
        ...
        setMessages([{role:"assistant",content:flow,verbatim:verbatim,type:"opponent"}]); setStage(2);
      } catch(e) { setMessages([{role:"assistant",content:"Error: "+e.message,verbatim:"",type:"opponent"}]); }
      setLoading(false);
    } else { setStage(0); setAppMode("practice"); }
  };

  const handleUserSpeech = async function() {
    const userText=transcript.trim()||input.trim();
    if (!userText||loading||speaking) return;
    setInput(""); setTranscript(""); setInterim("");
    setMessages(function(prev){return prev.concat([{role:"user",content:userText,type:"user"}]);});
    if (userSide==="Affirmative") {
      if (stage===0){setStage(1);await botSpeak(ROUND_PROMPTS.opp_rebuts_and_constructs(resolution,userText));setStage(2);}
      else if(stage===2){setStage(3);await botSpeak(ROUND_PROMPTS.opp_rebuts_gov_extended(resolution,userText));setStage(4);}
      else if(stage===4){setStage(5);await botSpeak(ROUND_PROMPTS.bot_whip(resolution,"Negative",userText));setStage(6);}
      else if(stage===6){setStage(7);await botSpeak(ROUND_PROMPTS.judge_critique(resolution,"Affirmative","Negative",userText,difficulty),"judge",true);setRoundOver(true);}
    } else {
      if(stage===2){setStage(3);await botSpeak(ROUND_PROMPTS.gov_rebuts_and_extends(resolution,userText));setStage(4);}
      else if(stage===4){setStage(6);}
      else if(stage===6){setStage(5);await botSpeak(ROUND_PROMPTS.bot_whip(resolution,"Affirmative",userText));setStage(7);await botSpeak(ROUND_PROMPTS.judge_critique(resolution,"Negative","Affirmative",userText,difficulty),"judge",true);setRoundOver(true);}
    }
  };
  ...
  const getProgressSteps = function() {
    if (userSide==="Affirmative") return [
      {label:"Aff 1",active:stage===0,done:stage>0},{label:"Neg 1",active:stage===1,done:stage>1},
      {label:"Aff 2",active:stage===2,done:stage>2},{label:"Neg 2",active:stage===3,done:stage>3},
      {label:"Neg 3",active:stage===5,done:stage>5},{label:"Aff 3",active:stage===6,done:stage>6},
      {label:"Judge",active:stage===7,done:roundOver},
    ];
    return [
      {label:"Aff 1",active:stage===1,done:stage>1},{label:"Neg 1",active:stage===2,done:stage>2},
      {label:"Aff 2",active:stage===3,done:stage>3},{label:"Neg 2",active:stage===4,done:stage>4},
      {label:"Neg 3",active:stage===6,done:stage>6},{label:"Aff 3",active:stage===7,done:roundOver},
      {label:"Judge",active:stage===7,done:roundOver},
    ];
  };

  const resetToLanding = function() {
    doStopSpeaking(); if(recognitionRef.current) recognitionRef.current.stop();
    setSpeaking(false); setRecording(false); setTranscript(""); setInterim("");
    setAppMode("landing"); setSetupSide(null); setSetupResMode(null); setSetupResText("");
    setSetupLoading(false); setSetupDifficulty("varsity"); setResolution("");
    setUserSide(null); setBotSide(null); setStage(0); setMessages([]); setInput(""); setRoundOver(false); setLoading(false);
  };
  ...
  const sendCaseMessage = async function(text, isFeedback) {
    ...
    setCaseMsgs(newMsgs); setCaseInput(""); setCaseFeedbackMode(null); setCaseFeedbackText(""); setCaseLoading(true);
    try {
      ...
      const res=await fetch("/api/gemini",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:SYSTEM_PROMPT,messages:apiMsgs})});
      const data=await res.json();
      setCaseMsgs(newMsgs.concat([{role:"assistant",content:data.text||"No response."}]));
    } catch(e) { setCaseMsgs(newMsgs.concat([{role:"assistant",content:"Error, please try again."}])); }
  ...
  const formatMessage = function(text) {
    return text.split("\n").map(function(line,i) {
      ...
      if (/^\*\*(.+)\*\*/.test(line)) { const parts=line.split(/\*\*/g); return <div key={i} style={{marginBottom:2}}>{parts.map(function(p,j){return j%2===1?<strong key={j}>{p}</strong>:<span key={j}>{p}</span>;})}</div>; }
  ...
  const homeBtn = { background:"transparent", border:"1px solid rgba(240,240,238,0.12)", borderRadius:6, padding:"4px 10px", fontSize:9, color:"rgba(240,240,238,0.4)", cursor:"pointer", fontFamily:"'DM Mono',monospace", letterSpacing:"0.08em", textTransform:"uppercase" };
  ...
  if (appMode==="landing") {
    return (
      <div style={s.app}>
        ...
        <div style={{overflow:"hidden",borderBottom:"1px solid rgba(240,240,238,0.06)",height:28,display:"flex",alignItems:"center"}}>
        ...
        <div style={s.landing}>
          <div style={s.landingCard}>
            ...
            <p style={s.landingTitle}>Win the<br/>round.</p>
            ...
            <div style={s.setupSection}>
              ...
              <div style={s.diffGrid}>
                {Object.entries(DIFFICULTY).map(function(entry){
                  ...
                  return <button key={key} style={s.diffBtn(setupDifficulty===key,d.color,d.bg)} onClick={function(){setSetupDifficulty(key);}}>{d.label}<div style={{fontSize:10,fontWeight:400,marginTop:3,opacity:0.8}}>{d.description}</div></button>;
                })}
              </div>
            </div>
            <div style={s.setupSection}>
              ...
              <div style={s.optionGrid}>
                <button style={setupResMode==="generating"?Object.assign({},s.optionBtn,{opacity:0.5}):s.optionBtn} onClick={generateResolution} disabled={setupLoading}>{setupLoading?"Generating...":"🎲 Generate one"}</button>
                <button style={setupResMode==="custom"?s.optionBtnActive:s.optionBtn} onClick={function(){setSetupResMode("custom");setSetupResText("");}}>✏️ Enter my own</button>
              </div>
              {(setupResMode==="custom"||setupResMode==="done") && <input autoFocus={setupResMode==="custom"} style={Object.assign({},s.resInput,{marginTop:10})} placeholder="Type your resolution..." value={setupResText} onChange={function(e){setSetupResText(e.target.value);}} />}
            </div>
      ...
      <div style={s.app}>
        ...
        <header style={s.header}>
          ...
          <div style={s.headerBadges}>
            ...
            {diff && <span style={{padding:"2px 9px",borderRadius:4,fontSize:9,fontWeight:500,fontFamily:"'DM Mono',monospace",letterSpacing:"0.1em",textTransform:"uppercase",background:"rgba(255,255,255,0.05)",color:diff.color,border:"1px solid rgba(255,255,255,0.1)"}}>{diff.label}</span>}
            ...
            <button onClick={resetToLanding} style={homeBtn}>← Home</button>
          </div>
        </header>
        <div style={s.body}>
          <aside style={s.sidebar}>
            <div style={s.sideSection}>
              ...
              <div style={{fontSize:11,color:RF.fgMuted,lineHeight:1.6,padding:"8px 10px",background:RF.bgInput,borderRadius:6,border:"1px solid "+RF.hairline}}>{resolution}</div>
            </div>
            <div style={s.sideSection}>
              <p style={s.sideLabel}>Round Progress</p>
              {steps.map(function(step,i){
                return <div key={i} style={{display:"flex",alignItems:"center",gap:9,marginBottom:8}}>
                  ...
                  <span style={{fontSize:11,fontWeight:step.active?600:400,color:step.done?RF.fg:step.active?"rgba(251,191,36,0.9)":RF.fgDim}}>{step.label}</span>
                </div>;
              })}
            </div>
          ...
          <main style={s.chat}>
            <div style={s.messages}>
              {messages.length===0&&!loading&&(
                <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:8,textAlign:"center"}}>
                  ...
                  {userSide==="Affirmative"&&<p style={{fontSize:13,color:RF.fgMuted,margin:0}}>You open. Deliver your Aff 1 below.</p>}
                </div>
              )}
              {messages.map(function(msg,i){
                return <div key={i} style={msg.role==="user"?s.msgWrapUser:s.msgWrapAsst}>
                  <div style={msg.role==="user"?s.msgUser:msg.type==="judge"?s.msgAsstJudge:s.msgAsstOpponent}>
                    {msg.role==="assistant"&&msg.type==="opponent"&&<div style={Object.assign({},s.msgTag,{color:"rgba(253,164,175,0.7)"})}>{botSide==="Negative"?"⚔ Neg":"⚔ Aff"}</div>}
                    {msg.role==="assistant"&&msg.type==="judge"&&<div style={Object.assign({},s.msgTag,{color:"rgba(74,222,128,0.7)"})}>{" 🏛 Judge's Decision"}</div>}
              ...
              {loading&&(
                <div style={s.msgWrapAsst}>
                  <div style={s.msgAsstOpponent}>
                    <div style={Object.assign({},s.msgTag,{color:"rgba(253,164,175,0.7)"})}>{botSide==="Negative"?"⚔ Neg":"⚔ Aff"}</div>
            ...
            <div style={s.inputBar}>
              ...
              {speaking&&<div style={{fontSize:9,color:"rgba(196,181,253,0.9)",fontWeight:500,marginBottom:6,fontFamily:"'DM Mono',monospace",letterSpacing:"0.1em",textTransform:"uppercase"}}>🔊 Opponent speaking</div>}
              {!userTurn&&!loading&&!speaking&&!roundOver&&<div style={{fontSize:9,color:RF.fgDim,marginBottom:6,fontFamily:"'DM Mono',monospace",letterSpacing:"0.1em",textTransform:"uppercase"}}>Opponent is preparing...</div>}
              {roundOver&&<div style={{fontSize:9,color:"rgba(74,222,128,0.8)",fontWeight:500,marginBottom:6,fontFamily:"'DM Mono',monospace",letterSpacing:"0.1em",textTransform:"uppercase"}}>Round complete</div>}
              <div style={s.inputRow}>
                ...
                <div style={s.transcriptBox}>
                  {(transcript||interim)
                    ?<span>{transcript}<span style={{color:RF.fgDim}}>{interim}</span></span>
                    :<span style={{color:RF.fgDim}}>{roundOver?"Round over.":!userTurn?"Waiting...":"Mic to speak, or type below"}</span>
                  }
                </div>
